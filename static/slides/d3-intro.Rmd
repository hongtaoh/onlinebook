...
---
background-image: url(bostock.png)
...
---
background-image: url(elevation-scan.png)
...
---
background-image: url(women-architects.png)
...
---
background-image: url(sankey.png)
background-size: 800px
...
---
background-image: url(choropleth.png)
background-size: 800px
background-position: 50% 50%
...
---
background-image: url(fatality.png)
...
---
background-image: url(bars-example.png)
background-size: 880px
...
---
class: inverse
background-image: url(observable.png)
background-size: 800px
background-position: 50% 50%
